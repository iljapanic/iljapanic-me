...
//     var activator2 = document.querySelectorAll('.splash__colophon a');
...
//     for (var i in activator2) {
//         if (!activator2.hasOwnProperty(i)) continue;
//         activator2[i].addEventListener( 'mouseover', function() {
//             // document.body.className = 'splash-1';
//             classie.add( splash, 'splash-3' );
//             classie.remove( splash, 'splash-1' );
//         })
//         activator2[i].addEventListener( 'mouseout', function() {
//             classie.add( splash, 'splash-1' );
//             classie.remove( splash, 'splash-3' );
//         })
//     }
// }